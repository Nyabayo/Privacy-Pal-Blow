...
import { idlFactory } from './blow_storage.did.js';
export { idlFactory } from './blow_storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLOW_STORAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blow_storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the blow_storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blow_storage.did.js")._SERVICE>}
 */
export const blow_storage = createActor(canisterId);
